...
<div class="content-page">
    ...
    <div class="content">
        <div class="wraper container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title"> Edit Subject </h4>
                ...
                <div class="col-lg-12">
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            ...
                            <h3 class="panel-title">Edit Subject</h3> </div>
                            <div class="panel-body rm02 rm04">
                                <form role="form" id="frm" method="post" action="{{route('subject.update')}}" enctype="multipart/form-data">
                                    @csrf
                             ...
                             <div class="form-group rm50">
                                        ...
                                        <input type="text"  class="form-control" id="AboutMe" placeholder="Enter question"  name="name" value="{{@$subject->name}}">
                             </div>
                              ...
                              <div class="form-group">
                                        ...
                                        <select name="course" class="form-control rm06" style="color: black" >
                                             ...
                                             @foreach($course as $val)
                                              <option value="{{$val->id}}" @if($val->id==@$subject->course_id)
