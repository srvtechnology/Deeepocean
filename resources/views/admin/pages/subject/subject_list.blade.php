...
<div class="content-page">
	...
	<div class="content">
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-12">
					<h4 class="pull-left page-title">Subject Management</h4>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="add-btn " style="float: right"><a href="{{route('subject.add.form')}}"><i class="icofont-plus-circle"></i> Add</a></div>
										...
										<table class="table">
											...
											<tbody>
												...
												<tr>
													...
													<td>{{ $key+ $all_subject->firstItem() }}</td>
													
													<td>{{$value->name}}</td>
													<td>{{@$value->getCourseDetails->name}}</td>
													...
													<td class="rm07">
														...
														<ul>
															<li><a href="{{route('edit.subject',$value->id)}}">Edit</a></li>
															
															@if($value->status=="I")
															<li><a onclick="return confirm('Are You Sure want to active this subject?');" href="{{route('subject.status.active',$value->id)}}" >Active</a></li>
															@else
															<li><a onclick="return confirm('Are You Sure want to inactive this subject?');" href="{{route('subject.status.inactive',$value->id)}}" >Inactive</a></li>
															@endif
															<li><a onclick="return confirm('Are You Sure want to delete this subject?');" href="{{route('subject.status.delete',$value->id)}}" >Delete</a></li>
              ...
              console.log(allVals);
                ...
                if(check == true){  
                   ...
                   $.ajaxSetup({
                      ...
                      $.ajax({
                      url:'{{route('multi.delete.subject')}}',
                      type:'POST',
                      data: fd,
                      contentType: false,
                      processData: false,
