    ...
    <div class="content-page">
      ...
      <div class="content">
        <div class="container">
          ...
          <div class="row">
            <div class="col-sm-12">
              <h4 class="pull-left page-title">Inspiration Management</h4>
              <ol class="breadcrumb pull-right">
                <li><a href="{{route('admin.dashboard')}}">DEEEP OCEAN</a></li>
                <li class="active">Inspiration Management</li>
              </ol>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              @include('admin.include.message')
               <div class="add-btn "><a href="{{route('insp.add.form')}}"><i class="icofont-plus-circle"></i> Add</a></div>
                             ...
                             <td>{{@$value->name}}</td>
                              ...
                              <td class="rm07">
                                ...
                                <div class="show-actions" id="show-action{{$value->id}}" style="display: none;"> <span class="angle"><img src="{{url('/')}}/adminasset/assets/images/angle.png" alt=""></span>
                                  <ul>
                                    <li><a href="{{route('view.insp',$value->id)}}">View</a></li>

                                    <li><a href="{{route('edit.insp',$value->id)}}">Edit</a></li>


                                  

                                    	@if($value->status=="I")
		                               <li><a onclick="return confirm('Are You Sure want to active this inspiration?');" href="{{route('insp.status.active',$value->id)}}" >Active</a></li>
		                              	@else
		                              	  <li><a onclick="return confirm('Are You Sure want to inactive this inspiration?');" href="{{route('insp.status.inactive',$value->id)}}" >Inactive</a></li>
		                              	@endif
		                              	 ...
		                              	 <li><a onclick="return confirm('Are You Sure want to delete this inspiration?');" href="{{route('insp.status.delete',$value->id)}}" >Delete</a></li>
