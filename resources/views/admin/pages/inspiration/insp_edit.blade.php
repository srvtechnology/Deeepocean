...
@section('title')
<title>Admin | Edit Inspiration</title>
@endsection
@section('left_part')
...
<div class="content-page">
    ...
    <div class="content">
        <div class="wraper container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title"> Edit Inspiration </h4>
            ...
            <div class="add-btn "><a href="{{route('insp.list')}}"><i class="icofont-minus-circle"></i> Back</a></div>
            <div class="row">
                <div class="col-lg-12">
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            ...
                            <h3 class="panel-title">Edit Inspiration</h3> </div>
                            <div class="panel-body rm02 rm04">
                                <form role="form" id="frm" method="post" action="{{route('update.insp')}}" enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" name="id" value="{{@$insp->id}}">
                                    <div class="form-group rm50">
                                        <label for="title">Name  <span style="color: red;">*</span></label>
                                        <input type="text" placeholder="Name"   class="form-control" name="name" value="{{$insp->name}}">
                                    </div>
                                    
                                
                                    <div class="form-group rm50">
                                        <label for="meta description">Description  <span style="color: red;">*</span></label>
                                       {{--  <input type="text" placeholder="Description"  class="form-control" name="desc" value="{{$insp->text}}" id="des" style="width: 500px;height: 100px"> --}}
                                        <textarea placeholder="Description"  class="form-control" name="desc" id="des" style="width: 500px;height: 100px">{{$insp->text}} </textarea>
                                    </div>
                                    ...
                                    <div class="clearfix"></div>
                                     <div class="form-group rm50 vdo-class">
                                       ...
                                       <img src="{{url('/')}}/storage/app/public/inspiration/{{@$insp->image}}" style="width: 300px;">
                                    </div>
  ...
  submitHandler: function(form){
                ...
                if(words >9 && words <21 ) {
                   ...
                   // return false;
                    ...
                    alert("Please enter words within 10 to 20.");
