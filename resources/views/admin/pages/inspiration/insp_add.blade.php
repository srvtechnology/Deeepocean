...
@section('title')
<title>Admin | Add Inspiration</title>
@endsection
@section('left_part')
...
<div class="content-page">
    ...
    <div class="content">
        <div class="wraper container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title"> Add Inspiration </h4>
                ...
                <div class="col-lg-12">
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            ...
                            <h3 class="panel-title">Add Inspiration</h3> </div>
                            <div class="panel-body rm02 rm04">
                                <form role="form" id="frm" method="post" action="{{route('insp.insert')}}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group rm50">
                                       ...
                                       {{--  <input type="text" placeholder="Description"  class="form-control" name="desc" id="des" value="{{old('desc')}}" style="width: 500px;height: 100px"> --}}
