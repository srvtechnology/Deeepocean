...
<div class="content-page">
	...
	<div class="content">
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-12">
					<h4 class="pull-left page-title">Course Management</h4>
											...
											<tbody>
												...
												<tr>
													...
													<td class="rm07">
														...
														<ul>
															<li><a href="{{route('edit.course',$value->id)}}">Edit</a></li>
															
															@if($value->status=="I")
															<li><a onclick="return confirm('Are You Sure want to active this course?');" href="{{route('course.status.active',$value->id)}}" >Active</a></li>
															@else
															<li><a onclick="return confirm('Are You Sure want to inactive this course?');" href="{{route('course.status.inactive',$value->id)}}" >Inactive</a></li>
															@endif
