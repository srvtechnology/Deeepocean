                    ...
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            ...
                            <div class="panel-body rm02 rm04">
                                <form role="form" id="frm" method="post" action="{{route('course.update')}}" enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" name="course_id" value="{{@$course->id}}">
                                    
                                    <div class="form-group rm50">
                                        <label for="title">Course name <span style="color: red;">*</span></label>
                                        <input type="text"  class="form-control" id="AboutMe" placeholder="Enter question"  name="name" value="{{@$course->name}}" >
                                    </div>
