...
<div class="content-page">
	...
	<div class="content">
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-12">
					<h4 class="pull-left page-title">Manage Content list</h4>
					<ol class="breadcrumb pull-right">
						<li><a href="{{route('admin.dashboard')}}">DEEEP OCEAN</a></li>
						<li class="active">Manage Content list</li>
					</ol>
				</div>
			</div>
			<div class="row">
											...
											<tbody>
												...
												<tr>
													...
													<td class="rm07">
														...
														<ul>
															<li><a href="{{route('content.edit',$value->id)}}">Edit</a></li>
