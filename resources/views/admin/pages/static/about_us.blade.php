					...
					<div>
						...
						<div class="panel panel-default panel-fill">
							...
							<div class="panel-body rm02 rm04">
								<form role="form" id="frm" method="post" action="{{route('aboutus.update')}}" enctype="multipart/form-data">
									@csrf
									...
									<div class="form-group rm03">
										<label for="FullName">About Us Content</label>
									...
									<div class="form-group">
										...
										<label for="image" style="margin-top: 10px;margin-bottom: 10px">Image dimension should be (500-1500 width) x (200-800 height)</label>
									...
									<div class="form-group rm50 vdo-class">
										...
										<img src="{{url('/')}}/storage/app/public/about_us/{{@$content->image}}" style="width: 300px;">
									</div>
