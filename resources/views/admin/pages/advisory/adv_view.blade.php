...
@section('title')
<title>Admin | View Advisory</title>
@endsection
@section('left_part')
...
<div class="content-page">
	...
	<div class="content">
		...
		<div class="wraper container-fluid">
			...
			<div class="row">
				<div class="col-sm-12">
					<h4 class="pull-left page-title">Advisory Page</h4>
					<ol class="breadcrumb pull-right">
						<li><a href="{{route('admin.dashboard')}}">DEEEP OCEAN</a></li>
						
						<li class="active">Advisory Page</li>
					</ol>
				</div>
			</div>
							...
							<div class="col-md-6">
								...
								<div class="panel panel-default panel-fill">
									<div class="panel-heading">
										<h3 class="panel-title">Advisory Information</h3>
									</div>
									<div class="panel-body">
										<div class="about-info-p">
											<strong>Advisory Name</strong>
											<br>
											<p class="text-muted">{{@$adv->name}}</p>
										</div>

										<div class="about-info-p">
											<strong>Advisory description</strong>
											<br>
											<p class="text-muted">{{@$adv->text}}</p>
										</div>
								...
								<div class="panel panel-default panel-fill">
									...
									<div class="panel-body">
										...
										<div class="about-info-p">
											<strong>Time</strong>
											<br>
											<p class="text-muted">{{@$adv->created_at}}</p>
										</div>
