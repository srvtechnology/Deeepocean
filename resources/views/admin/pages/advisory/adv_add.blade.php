...
@section('title')
<title>Admin | Add Advisory</title>
@endsection
@section('left_part')
...
<div class="content-page">
    ...
    <div class="content">
        <div class="wraper container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title"> Add Advisory </h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="{{route('admin.dashboard')}}">DEEEP OCEAN</a></li>
                        <li class="active">Add Advisory </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            ...
                            <h3 class="panel-title">Add Advisory</h3> </div>
                            <div class="panel-body rm02 rm04">
                                <form role="form" id="frm" method="post" action="{{route('adv.insert')}}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group rm50">
                                        ...
                                        {{-- <input type="text" placeholder="Description"  class="form-control" name="desc" id="des" style="width: 500px;" value="{{old('desc')}}"> --}}
