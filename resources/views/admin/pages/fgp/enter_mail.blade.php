...
@section('title')
<title>DEEP-OCEAN | Admin | Forget password</title>
@endsection
@section('head')
...
<div class="wrapper-page">
    <div class="panel panel-color panel-primary panel-pages">
        ...
        <div class="panel-body">
            <form method="POST" action="{{ route('email.entered.code.generate') }}" aria-label="{{ __('Login') }}" class="form-horizontal m-t-20" id="login_form">
                @csrf
