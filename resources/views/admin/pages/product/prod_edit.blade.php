                    ...
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            ...
                            <div class="panel-body rm02 rm04">
                                <form role="form" id="frm" method="post" action="{{route('update.prod')}}" enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" name="id" value="{{@$prod->id}}">
                                    <div class="form-group rm50">
                                        <label for="title">Name <span style="color: red;">*</span></label>
                                        <input type="text" placeholder="Name"   class="form-control" name="name" value="{{$prod->name}}">
                                    </div>

                                      <div class="form-group rm50">
                                        <label for="title">Link {{-- <span style="color: red;">*</span> --}}</label>
                                        <input type="text" placeholder="Link"   class="form-control" name="link" value="{{$prod->link}}">
                                    </div>
                                   ...
                                   {{--  <div class="form-group rm50">
                                        ...
                                        <textarea placeholder="Description"  class="form-control" name="desc" id="des" style="width: 500px;height: 100px">{{$prod->text}} </textarea>
                                    </div> --}}
                                    ...
                                    <div class="form-group rm50">
                                        ...
                                        <textarea id="mytextarea" placeholder="Description" name="desc" >{!!@$prod->text!!}</textarea>
                                        <style>
