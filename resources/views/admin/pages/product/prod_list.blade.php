                              ...
                              <td class="rm07">
                                ...
                                <div class="show-actions" id="show-action{{$value->id}}" style="display: none;"> <span class="angle"><img src="{{url('/')}}/adminasset/assets/images/angle.png" alt=""></span>
                                  <ul>
                                    ...
                                    <li><a href="{{route('view.prod',$value->id)}}">View</a></li>

                                    <li><a href="{{route('edit.prod',$value->id)}}">Edit</a></li>

                                  

                                    	@if($value->status=="I")
		                               <li><a onclick="return confirm('Are You Sure want to active this Product?');" href="{{route('prod.status.active',$value->id)}}" >Active</a></li>
		                              	@else
		                              	  <li><a onclick="return confirm('Are You Sure want to inactive this Product?');" href="{{route('prod.status.inactive',$value->id)}}" >Inactive</a></li>
		                              	@endif
		                              	 ...
		                              	 <li><a onclick="return confirm('Are You Sure want to delete this Product?');" href="{{route('prod.status.delete',$value->id)}}" >Delete</a></li>
