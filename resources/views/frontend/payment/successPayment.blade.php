...
<script>
  ...
  gtag('config', 'G-2HXT9TQQNR');
        ...
        <title>Thank You | Deep Ocean</title>
        {{--     <link rel="stylesheet" href="{{url('/')}}/assets/css/main.css" /> --}}
      ...
      <body class="thank-you">
        ...
        <div class="t-card card">
         ...
         <p> Course Registered Name: {{@$course->name}} </p>
          <br>
          <p>Your payment is successful with this transaction ID - {{@$getDetailsUser->transaction_id}}</p>
          <img src="{{url('/')}}/assets/img/fast-email.png" alt="" width="30" height="20" />
          <span>
            Your subscription is completed and you will receive a confirmation email shortly. Now, get your test every day.
          </span>
          <br />
          <span>
            If you have any questions please, contact us.
            WhatsApp number - 9990378888,<br> mail id – support@deeepocean.co.in
          </span>
